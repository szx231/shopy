    ...
    <>
      ...
      <Stack spacing="lg">
        ...
        <Group noWrap position="apart">
          <Group noWrap>
            <Skeleton height={42} radius="sm" visible={isListLoading} width="auto" sx={{ flexGrow: 0.25 }}>
              <TextInput
                size="md"
                value={search}
                ...
                rightSection={
                  search ? (
                    <UnstyledButton onClick={() => setSearch('')} sx={{ display: 'flex', alignItems: 'center' }}>
                      <IconX color="gray" />
                    </UnstyledButton>
                  ) : null
                }
            ...
            <Skeleton height={42} radius="sm" visible={isListLoading} width="auto" style={{ overflow: 'unset' }}>
              <DatePickerInput
                type="range"
                size="md"
